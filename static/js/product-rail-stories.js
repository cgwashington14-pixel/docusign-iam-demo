...
(function () {
  ...
  const SCENES = {
    ...
    workspaces: {
      invite: {
        eyebrow: 'EDD onboarding · Step 1',
        headline: 'Vendor invited to CA EDD hub',
        body: 'Acme Staffing joins a California EDD–branded workspace — controlled access for agreements and evidence uploads.',
        steps: [
          { icon: '🏛', text: 'Hub branded for California EDD', active: true },
          { icon: '✉', text: 'Invite sent to David Park' },
          { icon: '🔐', text: 'Participate role · activity logged' },
        ],
        footer: '<span class="ds-rail-story-tag">EDD vendor portal</span>',
      },
      redline: {
        eyebrow: 'EDD onboarding · Step 2',
        headline: 'Agreements staged to sign',
        body: 'Vendor Services Agreement and Confidentiality NDA are uploaded with Sign Here tabs — no email attachment sprawl.',
        steps: [
          { icon: '📄', text: 'EDD Vendor Services Agreement', active: true },
          { icon: '🔒', text: 'Confidentiality & Data Sharing NDA' },
          { icon: '✍', text: 'Draft envelopes ready' },
        ],
        footer: '<span class="ds-rail-story-tag">Docs to sign</span>',
      },
      approve: {
        eyebrow: 'EDD onboarding · Step 3',
        headline: 'Upload requests for compliance',
        body: 'Insurance certificates, STD 204 / W-9, and business license requests sit beside the signature pack.',
        steps: [
          { icon: '🛡', text: 'Certificate of Insurance', active: true },
          { icon: '📋', text: 'STD 204 + W-9' },
          { icon: '🏢', text: 'Business license / FTB 590' },
        ],
        footer: '<span class="ds-rail-story-tag">Evidence pack</span>',
      },
      archive: {
        eyebrow: 'EDD onboarding · Step 4',
        headline: 'One vendor record for EDD',
        body: 'Executed agreements and uploads stay in the hub — ready for Navigator, audit, and FI$Cal follow-on.',
        steps: [
          { icon: '📁', text: 'Executed pack stored', active: true },
          { icon: '🏷', text: 'Tagged EDD vendor onboarding' },
          { icon: '🔗', text: 'Linked for audit trail' },
        ],

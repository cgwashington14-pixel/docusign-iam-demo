...
const SCV_COMPONENTS = {
  ...
  '/clm-troubleshoot': {
    ...
    what: 'A customer-facing CLM runbook — 101 of request → approve → external redline → remap attributes, then diagnose Failed vs stuck vs false Complete.',
    ...
    demo: [
      'Play the lifecycle 101 first — request, approvals, external redline, remap attributes.',

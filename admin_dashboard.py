...
ADMIN_PAGE_CATALOG = [
    ...
    },
    {
        ...
        "path": "/gov-agents",
        "category": "AI",
        "you_see": "Housing Assistance program with four Iris agents — live envelopes collect in one HAP workspace",
        "server_does": "Sends HAP envelopes via eSign and creates or updates a Workspaces hub",
        "uses_docusign": True,
        "backend": "high",
    },
    {
